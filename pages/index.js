...
export default function Home() {
  ...
  return (
    <div className="w-full flex items-center mt-10">
      {showPopup && (
        <div
          className="fixed z-50 top-0 left-0 w-full h-full bg-black bg-opacity-80 flex items-center justify-center"
          onBlur={handleClosePopup}
        >
          <div
            className="bg-gray-300 rounded-lg shadow-md p-2"
            onBlur={handleClosePopup}
          >
            <h2 className="text-2xl text-center mb-4">See How It Works</h2>
            <img
              src="/brainTumorProject/seeHow.gif"
              alt="gif"
              className="max-h-96 max-w-96 object-contain mx-auto mb-4 rounded-lg"
            />
          </div>
        </div>
      )}
