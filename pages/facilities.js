...
const ClinicPage = () => {
  ...
  <div className="flex justify-center gap-5">
    {cities.map((city, index) => (
      <div key={index} className="border-gray-400 border-2 p-4 rounded-lg shadow-md text-center h-[500px] w-[250px]">
        ...
        {city.subcity && (
          <>
            <h2 className="text-xl font-bold mt-4 mb-4">{city.subcity.name}</h2>
            <ul className="list-disc text-left ml-4">
  ...
  <div className="flex justify-center gap-5 mt-3">
    {cities2.map((city, index) => (
      <div key={index} className="border-gray-400 border-2 p-4 rounded-lg shadow-md text-center h-[300px] w-[250px]">
        <h2 className="text-xl font-bold mb-4">{city.name}</h2>
        <ul className="list-disc text-left ml-4">
          {city.hospitals.map((hospital, hospitalIndex) => (
            <li key={hospitalIndex}>{hospital}</li>
